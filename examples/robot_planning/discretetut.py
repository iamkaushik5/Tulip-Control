...
sys.transitions.add_comb({'X6'}, {'X3', 'X7'})
sys.transitions.add_comb({'X7'}, {'X6', 'X8', 'X4'})
sys.transitions.add_comb({'X8'}, {'X7', 'X5'})
...
sys_init = {'X0reach'}
sys_prog = {'home'}             # []<>home
sys_safe = {'(X (X0reach) <-> lot) || (X0reach && !park)', '!(obst4 && obs4)'}

#'!(obst1 && obs1)','!(obst4 && obs4)', '!(obst7 && obs7)'}
sys_prog |= {'X0reach'}
